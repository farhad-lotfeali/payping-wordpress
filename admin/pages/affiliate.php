...
function pp_affiliate_detail()
{
    ...
    $store = (array)$api->store($_GET['code'])->body;
    $distributor = $api->store_destributor($_GET['code'],($page-1)*$per_page,$per_page)->body;

    require dirname(__FILE__) . '/affiliate_detail.html.php';
}
